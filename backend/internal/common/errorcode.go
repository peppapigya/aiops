...
var (
	...
	// ========================  跳板机相关 ========================
	JumpserverHostNotExist      = NewErrorCode(60001, "主机不存在")
	JumpserverCredentialNotExist = NewErrorCode(60002, "凭证不存在")
	JumpserverPermissionDenied  = NewErrorCode(60003, "无权限访问该主机")
	JumpserverSessionNotExist   = NewErrorCode(60004, "会话不存在")
	JumpserverSSHConnectFailed  = NewErrorCode(60005, "SSH连接失败")
	JumpserverApprovalRequired  = NewErrorCode(60006, "需要审批授权")
	JumpserverApprovalRejected  = NewErrorCode(60007, "审批已拒绝")
	JumpserverRiskCommandBlocked = NewErrorCode(60008, "危险命令已被拦截")
)
