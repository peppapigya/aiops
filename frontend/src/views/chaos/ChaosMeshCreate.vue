            ...
            <div v-if="formData.faultType === 'PodChaos'">
              <el-form-item label="故障动作" prop="action">
                <el-select v-model="formData.spec.action" placeholder="请选择故障动作">
                  <el-option label="杀Pod" value="pod-kill" />
                  <el-option label="Pod故障" value="pod-failure" />
                  <el-option label="杀容器" value="container-kill" />
                </el-select>
              </el-form-item>
              ...
              <el-form-item label="影响模式">
                <el-select v-model="formData.spec.mode" placeholder="请选择影响模式">
                  <el-option label="一个" value="one" />
                  <el-option label="全部" value="all" />
                  <el-option label="固定数量" value="fixed" />
                  <el-option label="固定百分比" value="fixed-percent" />
                  <el-option label="随机最大百分比" value="random-max-percent" />
                </el-select>
              </el-form-item>
            ...
            <div v-if="formData.faultType === 'NetworkChaos'">
              <el-form-item label="故障动作" prop="action">
                <el-select v-model="formData.spec.action" placeholder="请选择故障动作">
                  ...
                  <el-option label="损坏" value="corrupt" />
              ...
              <el-form-item label="影响方向">
                <el-select v-model="formData.spec.direction" placeholder="请选择影响方向">
                  <el-option label="发送" value="to" />
                  <el-option label="接收" value="from" />
          ...
          <el-form :model="formData.spec" :rules="step3Rules" ref="formStep3" label-width="120px">
            <el-form-item label="选择方式">
              <el-radio-group v-model="targetMode">
                <el-radio value="label">标签</el-radio>
                ...
                <el-alert :closable="false" class="eviction-alert" type="warning">
                  <template #default>
                    ...
                    <ol class="eviction-steps-list">
                      <li>给演练节点打上 <code>不调度</code> 污点</li>
                      <li>修补 目标 Deployment，加入 Toleration + NodeAffinity</li>
                      <li>驱逐 目标 Pod，Pod 将在演练节点重建</li>
