  ...
  <div class="editor-root" v-loading="loadingData">
    ...
    <div class="top-bar">
      ...
      <div class="top-bar-meta">
        ...
        <el-input v-model="form.gitUrl"   size="small" placeholder="Git 地址 *"    style="width:220px">
...
.step-node:hover { box-shadow: none; border-color: var(--ds-border-strong); background: var(--ds-bg-surface-2); }
.step-node--selected { border-color: var(--ds-accent); box-shadow: none; }
...
.sn-icon { color: var(--ds-accent); font-size: 12px; flex-shrink: 0; }
.sn-name {
  flex: 1;
  font-size: 11px;
  font-weight: 600;
...
.no-deps { font-size: 12px; color: var(--ds-text-muted); }
...
.gc-icon { color: var(--ds-accent); font-size: 12px; flex-shrink: 0; }
.gc-title { font-size: 11px; font-weight: 700; color: var(--ds-accent-hover); }
.gc-url {
  font-size: 10px;
...
.gc-branch { font-size: 10px; color: var(--ds-text-tertiary); padding-left: 2px; margin-top: 2px; }
