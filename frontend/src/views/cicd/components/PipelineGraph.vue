...
/* Status Colors */
.node-success .node-icon { background: var(--ds-bg-success-subtle); color: var(--ds-success); }
.node-success { border-left: 3px solid #67c23a; }

.node-failed .node-icon { background: var(--ds-bg-danger-subtle); color: var(--ds-error); }
.node-failed { border-left: 3px solid #f56c6c; }

.node-running .node-icon { background: var(--ds-bg-info-subtle); color: var(--ds-accent); }
.node-running { border-left: 3px solid #409eff; }

.node-pending .node-icon { background: var(--ds-bg-surface-2); color: var(--ds-text-tertiary); }
</style>
