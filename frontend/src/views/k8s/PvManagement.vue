      ...
      <el-form :model="createForm" ref="createFormRef" label-width="120px">
        <el-tabs v-model="activeTab" type="border-card">
          <el-tab-pane label="表单创建" name="form">
            ...
            <el-form-item label="NFS服务器">
               <el-input v-model="createForm.nfs.server" placeholder="NFS服务器IP" />
            </el-form-item>
    ...
    <el-dialog v-model="showDetailDialog" title="PV 详情" width="800px">
       <div v-if="currentPv">
         <el-descriptions :column="1" border>
            ...
            <el-descriptions-item label="容量" v-if="currentPv.spec.capacity">{{ currentPv.spec.capacity.storage }}</el-descriptions-item>
            <el-descriptions-item label="存储类">{{ currentPv.spec.storageClass }}</el-descriptions-item>
            <el-descriptions-item label="回收策略">{{ currentPv.spec.persistentVolumeReclaimPolicy }}</el-descriptions-item>
         </el-descriptions>
       </div>
    </el-dialog>
  </div>
