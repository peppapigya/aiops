    ...
    <el-card class="content-card cyber-card">
      <div class="autoops-table-wrapper">
        ...
        >
          ...
          <el-table-column prop="provisioner" label="供应者" min-width="250" show-overflow-tooltip />
      ...
      <el-form :model="createForm" ref="createFormRef" label-width="120px">
        <el-tabs v-model="activeTab" type="border-card">
          <el-tab-pane label="表单创建" name="form">
            ...
            <el-form-item label="供应者" prop="provisioner" required>
              <el-input v-model="createForm.provisioner" placeholder="例如: kubernetes.io/aws-ebs" />
            </el-form-item>
             <el-form-item label="回收策略" prop="reclaimPolicy">
               <el-select v-model="createForm.reclaimPolicy">
                 <el-option label="删除" value="Delete" />
                 <el-option label="保留" value="Retain" />
               </el-select>
             </el-form-item>
          </el-tab-pane>
    ...
    <el-dialog v-model="showDetailDialog" title="StorageClass 详情" width="800px">
       <div v-if="currentSc">
         <el-descriptions :column="1" border>
            ...
            <el-descriptions-item label="供应者">{{ currentSc.provisioner }}</el-descriptions-item>
            <el-descriptions-item label="回收策略">{{ currentSc.reclaimPolicy }}</el-descriptions-item>
         </el-descriptions>
       </div>
    </el-dialog>
  </div>
