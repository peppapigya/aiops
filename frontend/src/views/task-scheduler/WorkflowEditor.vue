...
.workflow-title { font-size: 13px; font-weight: 600; color: #303133; }
.top-bar-meta { display: flex; align-items: center; gap: 4px; flex: 1; }
...
.connect-menu-item:hover {
  background-color: var(--ds-bg-app, #0d1117);
  color: #409eff;
}
